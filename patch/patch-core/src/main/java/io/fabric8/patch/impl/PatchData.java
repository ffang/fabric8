...
public class PatchData {
    ...
    public static PatchData load(InputStream is) throws IOException {
        ...
        for (int i = 0; i < count; i++) {
            String source = props.getProperty(FILES + "." + Integer.toString(i) + "." + SOURCE);
            String target = props.getProperty(FILES + "." + Integer.toString(i) + "." + TARGET);
            result.files.put(target, source);
        }
        return result;
    }
